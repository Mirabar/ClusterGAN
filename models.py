...
def generator(in_sh1=(30,), in_sh2=(10,)):
    input_layer1 = Input(shape=in_sh1)
    input_layer2 = Input(shape=in_sh2)
    input_concat = concatenate([input_layer1, input_layer2])
    dense1 = dense_block(1024, input_concat)
